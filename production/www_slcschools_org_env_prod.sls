...
www_slcschools_org_env_prod_www_db_host:
  file.replace:
    - name: /etc/environment
    - repl: "WWW_DB_HOST=\"{{ salt['cmd.run']("echo 'U2FsdGVkX1/XjlP7Vw3XkNf1wLs0jecQimmWi2oS/APM6UwbIX/yvTuzSSeROz70' | openssl enc -d -kfile /saltsecrets -aes-256-cbc -base64",python_shell=True) }}\""
    - pattern: 'WWW_DB_HOST.*'
    - append_if_not_found: True
    - require:
